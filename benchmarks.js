...
(function () {
  ...
  var immhelper = require("immhelper").default;

  var immer = require("immer").default;

  var imh = require("./lib/index").default;
  ...
  var _solImh = {
    ...
    set: function (obj, key, val) {
      return imh(obj, imh.set(key, val));
    },
    getDeep: function (obj, key1, key2) {
      return obj[key1][key2];
    },
    ...
    merge: function (obj1, obj2) {
      return imh(obj1, imh.merge(obj2));
    },
    initArr: function (array) {
      if (!array) {
        array = INITIAL_ARRAY;
    ...
    setAt: function (arr, idx, val) {
      return imh(arr, imh.set(idx, val));
    },
    getAtDeep: function (arr, idx1, idx2) {
      return arr[idx1][idx2];
    },
